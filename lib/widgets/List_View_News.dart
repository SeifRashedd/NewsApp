...
class ListViewNews extends StatefulWidget {
  const ListViewNews({super.key, required this.catrgory,});
...
class _ListViewNewsState extends State<ListViewNews> {
  ...
  Widget build(BuildContext context) {
    return 
    isloading ? const SliverToBoxAdapter(child: Center(child: CircularProgressIndicator())) :  SliverList(delegate: SliverChildBuilderDelegate(
